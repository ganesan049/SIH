...
#ori#        parity_selector = parity_sequence_bindata.len 
        parity_selector = parity_sequence_bindata  # number of least signifficant bits to be discarded (>>) for parity to be readable by parity_mask
